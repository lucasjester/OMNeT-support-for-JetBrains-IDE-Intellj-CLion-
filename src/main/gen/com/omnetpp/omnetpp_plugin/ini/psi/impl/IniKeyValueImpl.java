...
public class IniKeyValueImpl extends ASTWrapperPsiElement implements IniKeyValue {

  public IniKeyValueImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public IniInivalue getInivalue() {
    return findChildByClass(IniInivalue.class);
  }
