...
public class NedOptLocaltypesImpl extends ASTWrapperPsiElement implements NedOptLocaltypes {

  public NedOptLocaltypesImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NedVisitor visitor) {
    visitor.visitOptLocaltypes(this);
  }
  ...
  @Override
  @Nullable
  public NedLocaltypes getLocaltypes() {
    return findChildByClass(NedLocaltypes.class);
  }
