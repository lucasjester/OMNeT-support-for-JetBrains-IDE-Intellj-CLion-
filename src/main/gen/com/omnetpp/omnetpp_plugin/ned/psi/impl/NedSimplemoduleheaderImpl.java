...
public class NedSimplemoduleheaderImpl extends NedNamedElementImpl implements NedSimplemoduleheader {

  public NedSimplemoduleheaderImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NedVisitor visitor) {
    visitor.visitSimplemoduleheader(this);
  }
