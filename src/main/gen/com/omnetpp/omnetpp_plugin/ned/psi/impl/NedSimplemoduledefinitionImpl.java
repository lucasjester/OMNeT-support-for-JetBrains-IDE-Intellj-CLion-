...
public class NedSimplemoduledefinitionImpl extends ASTWrapperPsiElement implements NedSimplemoduledefinition {

  public NedSimplemoduledefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NedVisitor visitor) {
    visitor.visitSimplemoduledefinition(this);
  }
  ...
  @Override
  @NotNull
  public NedSimplemoduleheader getSimplemoduleheader() {
    return findNotNullChildByClass(NedSimplemoduleheader.class);
  }
