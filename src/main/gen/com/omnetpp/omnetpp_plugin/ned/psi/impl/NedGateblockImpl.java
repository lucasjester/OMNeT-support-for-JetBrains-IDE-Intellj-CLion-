...
public class NedGateblockImpl extends ASTWrapperPsiElement implements NedGateblock {

  public NedGateblockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NedVisitor visitor) {
    visitor.visitGateblock(this);
  }
  ...
  @Override
  @NotNull
  public NedOptGates getOptGates() {
    return findNotNullChildByClass(NedOptGates.class);
  }
