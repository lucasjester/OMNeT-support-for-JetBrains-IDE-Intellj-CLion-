...
public class NedPropertyValueImpl extends ASTWrapperPsiElement implements NedPropertyValue {

  public NedPropertyValueImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<NedPropertyLiteral> getPropertyLiteralList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, NedPropertyLiteral.class);
  }
