...
public class NedOptGateblockImpl extends ASTWrapperPsiElement implements NedOptGateblock {

  public NedOptGateblockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NedVisitor visitor) {
    visitor.visitOptGateblock(this);
  }
  ...
  @Override
  @Nullable
  public NedGateblock getGateblock() {
    return findChildByClass(NedGateblock.class);
  }
