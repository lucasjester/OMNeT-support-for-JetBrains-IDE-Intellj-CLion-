...
public class NedOperatorImpl extends ASTWrapperPsiElement implements NedOperator {

  public NedOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public NedQname getQname() {
    return findChildByClass(NedQname.class);
  }
