...
public class NedOptSubgateImpl extends ASTWrapperPsiElement implements NedOptSubgate {

  public NedOptSubgateImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NedVisitor visitor) {
    visitor.visitOptSubgate(this);
  }
