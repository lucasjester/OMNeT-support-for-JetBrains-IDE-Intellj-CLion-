...
public class NedOptGatesImpl extends ASTWrapperPsiElement implements NedOptGates {

  public NedOptGatesImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NedVisitor visitor) {
    visitor.visitOptGates(this);
  }
  ...
  @Override
  @Nullable
  public NedGates getGates() {
    return findChildByClass(NedGates.class);
  }
