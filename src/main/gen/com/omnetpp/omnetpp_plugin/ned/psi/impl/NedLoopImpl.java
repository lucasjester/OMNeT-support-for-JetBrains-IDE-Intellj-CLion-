...
public class NedLoopImpl extends ASTWrapperPsiElement implements NedLoop {

  public NedLoopImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<NedExpression> getExpressionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, NedExpression.class);
  }
