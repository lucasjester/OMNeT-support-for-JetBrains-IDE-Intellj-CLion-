...
public class NedPatternIndexImpl extends ASTWrapperPsiElement implements NedPatternIndex {

  public NedPatternIndexImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NedVisitor visitor) {
    visitor.visitPatternIndex(this);
  }
