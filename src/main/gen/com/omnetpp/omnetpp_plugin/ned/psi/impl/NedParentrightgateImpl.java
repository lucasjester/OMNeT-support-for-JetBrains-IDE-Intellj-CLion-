...
public class NedParentrightgateImpl extends ASTWrapperPsiElement implements NedParentrightgate {

  public NedParentrightgateImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NedVisitor visitor) {
    visitor.visitParentrightgate(this);
  }
  ...
  @Override
  @NotNull
  public NedOptSubgate getOptSubgate() {
    return findNotNullChildByClass(NedOptSubgate.class);
  }
