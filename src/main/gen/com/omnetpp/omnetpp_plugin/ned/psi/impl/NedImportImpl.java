...
public class NedImportImpl extends ASTWrapperPsiElement implements NedImport {

  public NedImportImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public NedImportspec getImportspec() {
    return findNotNullChildByClass(NedImportspec.class);
  }
