...
public class NedObjectImpl extends ASTWrapperPsiElement implements NedObject {

  public NedObjectImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public NedOptKeyvaluelist getOptKeyvaluelist() {
    return findNotNullChildByClass(NedOptKeyvaluelist.class);
  }
