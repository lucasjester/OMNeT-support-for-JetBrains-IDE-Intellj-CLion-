...
public class NedDefinitionsImpl extends ASTWrapperPsiElement implements NedDefinitions {

  public NedDefinitionsImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<NedDefinition> getDefinitionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, NedDefinition.class);
  }
