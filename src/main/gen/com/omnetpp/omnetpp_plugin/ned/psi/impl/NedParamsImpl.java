...
public class NedParamsImpl extends ASTWrapperPsiElement implements NedParams {

  public NedParamsImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<NedParamsitem> getParamsitemList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, NedParamsitem.class);
  }
