...
public class NedPropertydeclKeyImpl extends ASTWrapperPsiElement implements NedPropertydeclKey {

  public NedPropertydeclKeyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NedVisitor visitor) {
    visitor.visitPropertydeclKey(this);
  }
  ...
  public NedPropertyLiteral getPropertyLiteral() {
    return findNotNullChildByClass(NedPropertyLiteral.class);
  }
