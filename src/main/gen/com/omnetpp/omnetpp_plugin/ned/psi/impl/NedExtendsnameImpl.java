...
public class NedExtendsnameImpl extends ASTWrapperPsiElement implements NedExtendsname {

  public NedExtendsnameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NedVisitor visitor) {
    visitor.visitExtendsname(this);
  }
