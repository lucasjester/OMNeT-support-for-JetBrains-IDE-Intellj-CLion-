...
public class NedConditionImpl extends ASTWrapperPsiElement implements NedCondition {

  public NedConditionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public NedExpression getExpression() {
    return findNotNullChildByClass(NedExpression.class);
  }
