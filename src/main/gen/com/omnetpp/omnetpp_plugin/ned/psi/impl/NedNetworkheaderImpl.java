...
public class NedNetworkheaderImpl extends NedNamedElementImpl implements NedNetworkheader {

  public NedNetworkheaderImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NedVisitor visitor) {
    visitor.visitNetworkheader(this);
  }
