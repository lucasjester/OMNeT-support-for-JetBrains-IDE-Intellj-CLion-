...
public class NedPropertydeclHeaderImpl extends ASTWrapperPsiElement implements NedPropertydeclHeader {

  public NedPropertydeclHeaderImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NedVisitor visitor) {
    visitor.visitPropertydeclHeader(this);
  }
