...
public class NedChannelspecHeaderImpl extends ASTWrapperPsiElement implements NedChannelspecHeader {

  public NedChannelspecHeaderImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NedVisitor visitor) {
    visitor.visitChannelspecHeader(this);
  }
  ...
  public NedDottedname getDottedname() {
    return findChildByClass(NedDottedname.class);
  }
