...
public class NedChannelspecImpl extends ASTWrapperPsiElement implements NedChannelspec {

  public NedChannelspecImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NedVisitor visitor) {
    visitor.visitChannelspec(this);
  }
  ...
  @Override
  @Nullable
  public NedChannelspecHeader getChannelspecHeader() {
    return findChildByClass(NedChannelspecHeader.class);
  }
