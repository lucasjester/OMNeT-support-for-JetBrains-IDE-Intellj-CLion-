...
public class NedPackagedeclarationImpl extends ASTWrapperPsiElement implements NedPackagedeclaration {

  public NedPackagedeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
