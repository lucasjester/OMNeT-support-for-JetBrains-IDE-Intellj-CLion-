...
public class NedOptConnblockImpl extends ASTWrapperPsiElement implements NedOptConnblock {

  public NedOptConnblockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NedVisitor visitor) {
    visitor.visitOptConnblock(this);
  }
  ...
  @Override
  @Nullable
  public NedConnblock getConnblock() {
    return findChildByClass(NedConnblock.class);
  }
