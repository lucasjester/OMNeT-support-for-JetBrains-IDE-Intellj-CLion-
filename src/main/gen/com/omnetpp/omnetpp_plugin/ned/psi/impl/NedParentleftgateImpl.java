...
public class NedParentleftgateImpl extends ASTWrapperPsiElement implements NedParentleftgate {

  public NedParentleftgateImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NedVisitor visitor) {
    visitor.visitParentleftgate(this);
  }
