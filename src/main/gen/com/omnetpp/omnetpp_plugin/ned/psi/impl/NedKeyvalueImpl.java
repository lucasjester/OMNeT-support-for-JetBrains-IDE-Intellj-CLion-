...
public class NedKeyvalueImpl extends ASTWrapperPsiElement implements NedKeyvalue {

  public NedKeyvalueImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public NedExpr getExpr() {
    return findNotNullChildByClass(NedExpr.class);
  }

  @Override
  @NotNull
  public NedKey getKey() {
    return findNotNullChildByClass(NedKey.class);
  }
