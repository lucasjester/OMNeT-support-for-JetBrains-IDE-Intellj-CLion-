...
public class NedOptVolatileImpl extends ASTWrapperPsiElement implements NedOptVolatile {

  public NedOptVolatileImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NedVisitor visitor) {
    visitor.visitOptVolatile(this);
  }
