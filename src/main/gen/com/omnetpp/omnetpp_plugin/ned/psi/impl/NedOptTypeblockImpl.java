...
public class NedOptTypeblockImpl extends ASTWrapperPsiElement implements NedOptTypeblock {

  public NedOptTypeblockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NedVisitor visitor) {
    visitor.visitOptTypeblock(this);
  }
  ...
  @Override
  @Nullable
  public NedTypeblock getTypeblock() {
    return findChildByClass(NedTypeblock.class);
  }
