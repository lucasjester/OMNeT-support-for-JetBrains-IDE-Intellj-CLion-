...
public class NedSubmodulenameImpl extends ASTWrapperPsiElement implements NedSubmodulename {

  public NedSubmodulenameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NedVisitor visitor) {
    visitor.visitSubmodulename(this);
  }
  ...
  @Override
  @Nullable
  public NedExpression getExpression() {
    return findChildByClass(NedExpression.class);
  }
