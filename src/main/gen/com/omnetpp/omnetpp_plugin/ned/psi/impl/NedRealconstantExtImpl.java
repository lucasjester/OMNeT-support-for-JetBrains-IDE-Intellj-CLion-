...
public class NedRealconstantExtImpl extends ASTWrapperPsiElement implements NedRealconstantExt {

  public NedRealconstantExtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NedVisitor visitor) {
    visitor.visitRealconstantExt(this);
  }
