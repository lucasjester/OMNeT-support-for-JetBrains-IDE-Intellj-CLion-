...
public class NedChannelinterfacedefinitionImpl extends ASTWrapperPsiElement implements NedChannelinterfacedefinition {

  public NedChannelinterfacedefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NedVisitor visitor) {
    visitor.visitChannelinterfacedefinition(this);
  }
  ...
  @Override
  @NotNull
  public NedChannelinterfaceheader getChannelinterfaceheader() {
    return findNotNullChildByClass(NedChannelinterfaceheader.class);
  }
