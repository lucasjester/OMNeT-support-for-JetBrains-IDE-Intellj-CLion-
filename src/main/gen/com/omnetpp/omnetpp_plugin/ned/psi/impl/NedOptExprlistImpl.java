...
public class NedOptExprlistImpl extends ASTWrapperPsiElement implements NedOptExprlist {

  public NedOptExprlistImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NedVisitor visitor) {
    visitor.visitOptExprlist(this);
  }
  ...
  @Override
  @Nullable
  public NedExprlist getExprlist() {
    return findChildByClass(NedExprlist.class);
  }
