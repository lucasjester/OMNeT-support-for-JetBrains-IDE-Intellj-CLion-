...
public class NedOptSemicolonImpl extends ASTWrapperPsiElement implements NedOptSemicolon {

  public NedOptSemicolonImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NedVisitor visitor) {
    visitor.visitOptSemicolon(this);
  }
