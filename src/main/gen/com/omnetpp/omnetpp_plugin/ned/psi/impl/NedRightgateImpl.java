...
public class NedRightgateImpl extends ASTWrapperPsiElement implements NedRightgate {

  public NedRightgateImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NedVisitor visitor) {
    visitor.visitRightgate(this);
  }
