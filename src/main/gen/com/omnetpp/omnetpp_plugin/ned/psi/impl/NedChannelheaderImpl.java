...
public class NedChannelheaderImpl extends NedNamedElementImpl implements NedChannelheader {

  public NedChannelheaderImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NedVisitor visitor) {
    visitor.visitChannelheader(this);
  }
