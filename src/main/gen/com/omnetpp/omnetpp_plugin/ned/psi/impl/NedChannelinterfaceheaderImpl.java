...
public class NedChannelinterfaceheaderImpl extends NedNamedElementImpl implements NedChannelinterfaceheader {

  public NedChannelinterfaceheaderImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NedVisitor visitor) {
    visitor.visitChannelinterfaceheader(this);
  }
