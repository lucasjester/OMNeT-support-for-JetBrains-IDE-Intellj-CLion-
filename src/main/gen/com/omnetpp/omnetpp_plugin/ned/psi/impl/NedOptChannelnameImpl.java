...
public class NedOptChannelnameImpl extends ASTWrapperPsiElement implements NedOptChannelname {

  public NedOptChannelnameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NedVisitor visitor) {
    visitor.visitOptChannelname(this);
  }
