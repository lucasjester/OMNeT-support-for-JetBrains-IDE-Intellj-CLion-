...
public class NedGatesImpl extends ASTWrapperPsiElement implements NedGates {

  public NedGatesImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<NedGate> getGateList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, NedGate.class);
  }
