...
public class NedOptParamsImpl extends ASTWrapperPsiElement implements NedOptParams {

  public NedOptParamsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NedVisitor visitor) {
    visitor.visitOptParams(this);
  }
  ...
  @Override
  @Nullable
  public NedParams getParams() {
    return findChildByClass(NedParams.class);
  }
