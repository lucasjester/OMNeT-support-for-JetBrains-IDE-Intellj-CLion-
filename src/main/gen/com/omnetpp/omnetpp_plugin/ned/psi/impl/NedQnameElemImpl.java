...
public class NedQnameElemImpl extends ASTWrapperPsiElement implements NedQnameElem {

  public NedQnameElemImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NedVisitor visitor) {
    visitor.visitQnameElem(this);
  }
