...
public class NedPropertyLiteralImpl extends ASTWrapperPsiElement implements NedPropertyLiteral {

  public NedPropertyLiteralImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NedVisitor visitor) {
    visitor.visitPropertyLiteral(this);
  }
