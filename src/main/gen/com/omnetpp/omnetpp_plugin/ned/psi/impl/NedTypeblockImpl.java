...
public class NedTypeblockImpl extends ASTWrapperPsiElement implements NedTypeblock {

  public NedTypeblockImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public NedOptLocaltypes getOptLocaltypes() {
    return findNotNullChildByClass(NedOptLocaltypes.class);
  }
