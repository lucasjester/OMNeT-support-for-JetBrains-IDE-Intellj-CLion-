...
public class NedDefinitionImpl extends ASTWrapperPsiElement implements NedDefinition {

  public NedDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public NedImport getImport() {
    return findChildByClass(NedImport.class);
  }
  ...
  @Override
  @Nullable
  public NedPackagedeclaration getPackagedeclaration() {
    return findChildByClass(NedPackagedeclaration.class);
  }
