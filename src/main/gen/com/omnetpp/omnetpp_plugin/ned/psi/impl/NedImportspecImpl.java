...
public class NedImportspecImpl extends ASTWrapperPsiElement implements NedImportspec {

  public NedImportspecImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<NedImportname> getImportnameList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, NedImportname.class);
  }
